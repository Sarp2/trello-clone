...
const headingFont = localFont({
  src: "../../public/fonts/OpenSans_Condensed-Bold.ttf"
});
  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <div className={cn(
        ...
        <div className="mb-4 flex items-center border shadow-sm p-4 bg-amber-100
         text-amber-700 rounded-full uppercase">
          <Medal className="h-7 w-6 mr-2"/>
          No 1 task managment
        </div>
        <h1 className="text-3xl md:text-6xl text-center text-neutral-800 mb-6">
          Taskify help team to move
        </h1>
      ...
      <div className={cn(
        ...
        From high rises to the home office, the way your team works is uniqiue - 
